    ...
    <section className="relative w-full aspect-video bg-black rounded-2xl overflow-hidden border border-guardian-slate group shadow-2xl">
      ...
      <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
        <div className="flex gap-2">
          <div className="px-3 py-1.5 bg-black/60 backdrop-blur-md rounded-md border border-guardian-slate flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-guardian-alert animate-pulse" />
            <span className="text-[10px] font-mono tracking-widest text-slate-300 uppercase">Live: Channel_04_North</span>
          </div>
          <div className="px-3 py-1.5 bg-black/60 backdrop-blur-md rounded-md border border-guardian-slate flex items-center gap-2">
            <Search className="w-3 h-3 text-guardian-green" />
            <span className="text-[10px] font-mono tracking-widest text-slate-300 uppercase">ms-yolo_v8_ema</span>
          </div>
        </div>
        ...
        <div className="flex gap-2">
          <button 
            ...
            className={cn(
              "px-4 py-2 bg-gradient-to-r from-guardian-orange to-red-600 rounded-lg text-[11px] font-bold uppercase tracking-wider flex items-center gap-2 transition-all hover:scale-105 active:scale-95 disabled:opacity-50",
              isVerifying && "animate-pulse"
            )}
          >
            {isVerifying ? <RefreshCw className="w-3 h-3 animate-spin" /> : <Zap className="w-3 h-3 fill-current" />}
            {isVerifying ? 'Cloud Verifying...' : 'Cloud Verification'}
          </button>
          <button className="p-2 bg-black/60 backdrop-blur-md rounded-lg border border-guardian-slate text-slate-300 hover:text-white">
      ...
      <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
        <div className="flex flex-col gap-1">
          <div className="text-[32px] font-display font-medium text-white leading-none">
            10:45:22<span className="text-sm opacity-50 ml-1">UTC</span>
          </div>
          <div className="text-[10px] font-mono text-slate-400">COORD: 34.0195° N, 118.4912° W</div>
        </div>

        <div className="flex gap-6 items-end bg-black/40 backdrop-blur-sm p-3 rounded-xl border border-white/5">
          <div className="flex flex-col items-center">
            <span className="text-[9px] font-mono text-slate-500 uppercase mb-1">Wind</span>
            <span className="text-sm font-display font-bold text-guardian-green">12.5 <span className="text-[10px] font-normal">m/s</span></span>
          </div>
          <div className="flex flex-col items-center border-l border-white/10 pl-6">
            <span className="text-[9px] font-mono text-slate-500 uppercase mb-1">SWH Pred</span>
            <span className="text-sm font-display font-bold text-guardian-orange">2.34 <span className="text-[10px] font-normal">m</span></span>
          </div>
          <div className="flex flex-col items-center border-l border-white/10 pl-6">
            <span className="text-[9px] font-mono text-slate-500 uppercase mb-1">Obj Count</span>
